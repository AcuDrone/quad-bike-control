...
public:
     ...
     *
     * The bus is opened once by `main.cpp` — I2C1 is the external-header bus
     * (X14), reserved for this sensor alone — so this driver never calls
     * `Wire.begin()` itself. The pins are remembered only for the wedged-bus
     * recovery path.
     *
